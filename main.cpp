...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Thorus-seeder\n"
...
static const string mainnet_seeds[] = {"seed1.thorus-crypto.com", "seed2.thorus-crypto.com", "seed3.thorus-crypto.com", ""};
static const string testnet_seeds[] = {"testnet-dns.thorus-crypto.com", "testnet2-dns.thorus-crypto.com", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("thorus-crypto.com", 27505), true);
  }
  do {
